...
const moreSleepProducts: ProductCardProps[] = [
  ...
  },
  {
    ...
    description: "This is the pillowcase your hair and skin are craving. Blissy is the supermodel secret that keeps your hair and skin looking smooth and glowy in the morning.",
...
const sheets = [
  {
    ...
    description:
      "Oprah was right. Cozy Earth sheets are impossibly smooth, temperature-regulating, and helped me sleep better from night one.",
    features: [
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        ...
        <Card className="mb-8 overflow-hidden border-2 hover:shadow-lg transition-shadow">
          <div className="bg-orange-500 text-white text-center py-4 px-6 font-bold text-xl">BEST SHEETS OF 2026</div>
          <CardContent className="p-0">
            <div className="grid md:grid-cols-[300px_1fr] gap-0">
              {/* Left side - Image and Rank */}
              <div className="relative bg-muted/30 p-6 flex flex-col items-center justify-center">
