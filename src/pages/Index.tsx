            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-8">
                ...
                <h2 className="text-4xl md:text-5xl font-serif font-bold text-foreground mb-4">
                  Why Oprah Called <a href="https://cozyearth.com/" target="_blank" rel="noopener noreferrer" className="text-primary">Cozy Earth</a> Sheets "The Softest Ever"
                </h2>
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-8">
                <div className="space-y-6">
                  <p className="text-foreground leading-relaxed">
                    ...
                    for <a href="https://cozyearth.com/" target="_blank" rel="noopener noreferrer" className="text-primary">Cozy Earth's</a> bamboo viscose sheets, the internet went wild.
                  </p>
                  <p className="text-foreground leading-relaxed">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <p className="text-foreground mb-4">
                      ...
                      moisture, <a href="https://cozyearth.com/" target="_blank" rel="noopener noreferrer" className="text-primary">Cozy Earth</a> sheets actively regulate your temperature throughout the night.
                    </p>
